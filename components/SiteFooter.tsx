      ...
      <div className="mx-auto max-w-3xl px-5 py-10">
        <div className="grid gap-12 sm:grid-cols-2 sm:gap-10">
          <div>
            ...
            <ul className="mt-5 flex flex-wrap gap-x-6 gap-y-3 text-sm text-[var(--muted-fg)]">
              {navigate.map((item) => (
                <li key={item.href}>
                  <Link
                    href={item.href}
          ...
          <div>
            ...
            <ul
              className="mt-5 grid grid-cols-4 gap-2 sm:max-w-[14rem]"
...
function FooterIconLink({
  ...
  return (
    <Link
      href={href}
      className="flex h-10 w-10 items-center justify-center rounded-md border border-[var(--border)] text-[var(--muted-fg)] transition-colors hover:border-[var(--border-strong)] hover:text-[var(--foreground)]"
      aria-label={label}
      {...(external
